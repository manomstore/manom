...
$this->setFrameMode(true);
		$componentElementParams = array(
			...
			'COLOR_REF_PROP_CODE' => 'COLOR_REF',
			'PHOTO_PROP_CODE' => 'MORE_PHOTO',
			'SELL_PROD_CODE' => 'SELL_PROD',
			'TOP_FIELD_1_CODE' => 'TOP_FIELD_1',
			'TOP_FIELD_2_CODE' => 'TOP_FIELD_2',
			'TOP_FIELD_3_CODE' => 'TOP_FIELD_3',
			'COLOR_REF_HB_ID' => '2',
			'GARANTY_CODE' => 'GARANTY',
			'TEXT_UNDER_PHOTO_CODE' => 'TEXT_UNDER_PHOTO',
			'REVIEW_IBLOCK_ID' => '11',
			'QNA_CODE' => 'A_N_Q',
			'QNA_IBLOCK_ID' => 12,
			'DELIV_IBLOCK_ID' => 13,
			'YOUTUBE_CODE' => 'YOUTUBE',
			'ACCESS_PROD_CODE' => 'ACESS',
			'CHEAPER_PROD_CODE' => 'BUY_CHEAPER',
			'RECOM_CODE' => 'RECOM',
			'FILES_CODE' => 'FILES',
