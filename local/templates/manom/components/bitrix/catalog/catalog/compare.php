...
global $prodListForCompare;
$prodListForCompare = getProdListFavoritAndCompare('UF_COMPARE_ID');
?>
<?if($prodListForCompare){?>
	...
	<?$APPLICATION->IncludeComponent("bitrix:catalog.section", "compare", Array(
			...
			"DETAIL_URL" => '#PRODUCT_URL#?offer=#ID#',
