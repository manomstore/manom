		...
		<div class="cb-nav-style">
			...
			<div class="cb-nav-style__block">
				<label>
					...
					<img src="img/v-single.svg" alt="" class="v-single">
				</label>
				<label>
					<input class="radio" type="radio" name="style" id="v-block" checked>
					<img src="img/v-block.svg" alt="" class="v-block">
				</label>
				<label>
					<input class="radio" type="radio" name="style" id="v-line">
					<img src="img/v-line.svg" alt="" class="v-line">
				</label>
			</div>

		</div>
	</div>
	<div class="cb-single no-gutters">
