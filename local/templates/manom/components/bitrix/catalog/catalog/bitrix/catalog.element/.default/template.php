            ...
            <div class="product-sidebar-cover">
                <?php if ($arResult['CATALOG_AVAILABLE'] === 'Y'): ?>
                    ...
                    <div class="product-sidebar__cheap-reason">
                        <p>Этот товар доступен для продажи с незначительными повреждениями по заниженной цене. За подробной информацией обращайтесь по телефону 8 (495) 150-64-50</p>
                    </div>
