                ...
                <div class="tab-content">
                    ...
                    // foreach ($arResult['QNA_VALUES'] as $value): ?>
                        <div class="js-ui-accordion tab-content__accord"  id="accordion">
                            <h3 class="accordion">Есть ли Face ID?</h3>
                            ...
                            <h3 class="accordion">Какой объём аккумулятора?</h3>
                            <div class="accordion-block"><p>222</p></div>
                            <h3 class="accordion">Совместимость с Apple Watch</h3>
                            <div class="accordion-block"><p>333</p></div>
                            <h3 class="accordion">Поддержка 2 SIM</h3>
                            <div class="accordion-block"><p>444</p></div>
                        </div>
                    <?php
                // endforeach; ?>
                </div>
