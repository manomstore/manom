...
<thead><tr><td colspan="2"><h1><?echo GetMessage("subscr_auth_sect_title")?></h1></td></tr></thead>
<tr valign="top">
	<td width="40%">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="data-table">
<thead><tr><td colspan="2"><h1><?echo GetMessage("subscr_pass_title")?></h1></td></tr></thead>
<tr valign="top">
	<td width="40%">
		<p>e-mail<br /><input type="text" name="sf_EMAIL" size="20" value="<?echo $arResult["REQUEST"]["EMAIL"];?>" title="<?echo GetMessage("subscr_auth_email")?>" /></p>
	</td>
