...
<?if($arResult["ALLOW_ANONYMOUS"]=="Y" && $_REQUEST["authorize"]<>"YES" && $_REQUEST["register"]<>"YES"):?>
	...
	<thead><tr><h1><td colspan="2"><h1><?echo GetMessage("subscr_title_auth2")?></h1></h1></td></tr></thead>
	<tr valign="top">
		<td width="40%">
...
<?elseif($arResult["ALLOW_ANONYMOUS"]=="N" || $_REQUEST["authorize"]=="YES" || $_REQUEST["register"]=="YES"):?>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="data-table">
	<thead><tr><td colspan="2"><h1><?echo GetMessage("adm_auth_exist")?></h1></td></tr></thead>
	<tr valign="top">
		<td width="40%">
	...
	<?if($arResult["ALLOW_REGISTER"]=="Y"):
		...
		<?echo bitrix_sessid_post();?>
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="data-table">
		<thead><tr><td colspan="2"><h1><?echo GetMessage("adm_reg_new")?></h1></td></tr></thead>
		<tr valign="top">
			<td width="40%">
