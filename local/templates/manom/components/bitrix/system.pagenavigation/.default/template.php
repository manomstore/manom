...
<div class="articles__bottom">
	...
	<div class="articles__count">
		Статьи <span class="articles__current"><?=$arResult["NavFirstRecordShow"]?>—<?=$arResult["NavLastRecordShow"]?></span> из <span class="articles__total"><?=$arResult["NavRecordCount"]?></span>
	</div>
</div>
