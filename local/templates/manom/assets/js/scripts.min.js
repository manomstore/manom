...
// подстройка ползунка под введенные значения от 0 до 200000
  ...
  // $(document).on('click', ".cb-nav-pagination__item", function(e) {
  //   //var thisPage = $(this)
  //   $(document).find(".cb-nav-pagination__item").removeClass("active");
...
//   });
  ...
  $(".product-sidebar__total_count-up").on('click', function(e) {
    ...
    $(".product-sidebar__total-price-price").text(formatMoney(newCost));
  ...
  $(".product-sidebar__cheaper").on('click', function(e) {
	    ...
	    $(".product-sidebar__cheap-reason").toggleClass( "show" );
		}
  });
  // Кнопка Подробнее
  ...
  $(".shopcart-nav1 input").change(function() {
		if (!$(this).hasClass('slide-disable')){
	    $(".shopcart-item").fadeOut(0);
	    var idSection = $(this).val();
	    console.log(idSection);
	    $(".shopcart-items "+idSection).css("display", "flex").fadeIn(300);
		} else {
			preNum = parseInt($(this).attr('data-num'))-1;
			$(document).find('.shopcart-nav1 label[for="shopcart-tab'+preNum+'"]').click()
		}
...
// Смена стилей отображения каталога
  ...
  $("input[name='style-favour']").change(changeStyleCat);
    ...
    if ($(this).prop("checked")) {
      ...
      $(".pb-info__button").text("Сохранить");
			$(".pb-info__button[for='pb-info__button']").css({display: 'none'})
			$(document).find('#pb-info__button_save').css({display: 'inline-block'})
    } else {
      ...
      $(".pb-info__button").text("Редактировать");
			$(".pb-info__button[for='pb-info__button']").css({display: 'inline-block'})
			$(document).find('#pb-info__button_save').css({display: 'none'})
    };
  });
  ...
  // Смена секций на странице Доставка/оплата
  $(".shipping-nav1 input").change(function() {
    $(".shipping-item").fadeOut(0);
    var idSection = $(this).val();
    console.log(idSection);
    $(".shipping-items "+idSection).fadeIn(300);
  });


  // Переход на страницу Продукта
  var bgreen = "#3D8E65";
  // $(".preview-prod.link").on("click", function () {
  //     location.href = "product.html";
  // });
	$(".preview-prod__name, .preview-prod1__name, .sci-top__name, .p-name").not(".no-link").hover(
    function(){
      $(this).css({"color":bgreen, "cursor":"pointer"});
    },
    function(){
      $(this).css({"color":"#000"});
  });
  // $(".preview-prod__name, .preview-prod1__name, .sci-top__name, .sci-add__name, .p-name").on("click", function () {
  //     location.href = "product.html";
  // });
  $(".discount .preview-prod1__name").on("click", function () {
      location.href = "discount.html";
  });
	// мобильное top-menu
		var menuOpenClass = "top-nav--opened";
		var subMenuOPenClass = "submenu-mob--opened"
		$(".top-nav__toggle").click(function(evt) {
    evt.preventDefault();
    $(".top-nav").toggleClass(menuOpenClass);
    if ($(".submenu-mob").hasClass(subMenuOPenClass)) {
      $(".submenu-mob").removeClass(subMenuOPenClass)
		}
		if ($(".submenu-mob2").hasClass(subMenuOPenClass)) {
      $(".submenu-mob2").removeClass(subMenuOPenClass)
    }
  });
  $(".top-nav__layout").click(function() {
    $(".top-nav").toggleClass(menuOpenClass);
    if ($(".submenu-mob").hasClass(subMenuOPenClass)) {
      $(".submenu-mob").removeClass(subMenuOPenClass)
		}
...
//  mobile-submenu (временный код, только чтобы показать блок)
	$(".top-nav__list-item a.not-link").on("click", function (evt) {
		evt.preventDefault();
		$(this).siblings(".js-open-submenu").click();
	})
    $(".js-open-submenu").click(function (evt) {
        evt.preventDefault();
        var menuId = $(this).data("item-menu-id");
        $(".submenu-mob[data-item-second-submenu-id='" + menuId + "']").addClass(subMenuOPenClass);
    });
    $(".submenu-mob__back").click(function (evt) {
        evt.preventDefault();
        $(".submenu-mob").removeClass(subMenuOPenClass);
		});
	$(".js-open-sub-submenu").click(function (evt) {
		evt.preventDefault();
		var menuId2 = $(this).data("item-id");
		var currentMenuId = $(this).closest(".submenu-mob").data("item-second-submenu-id");
		$(".submenu-mob2[data-parent-id='" + currentMenuId + "'][data-item-third-submenu-id='" + menuId2 + "']").addClass(subMenuOPenClass);
	});
		 $(".submenu-mob__back2").click(function (evt) {
			evt.preventDefault();
			$(".submenu-mob2").removeClass(subMenuOPenClass);
	});
...
//  popup-block--search
    ...
    $(".popup-block").removeClass("popup-block--opened");
		};
  $(".top-personal__link--search").click(function(evt) {
    evt.preventDefault();
    $(".popup-block--search").toggleClass("popup-block--opened");
  });
  $(".popup-block__close").click(function(evt) {
    evt.preventDefault();
    closePopup();
  });
  $(".search-block__field form").submit(function() {
    closePopup();
  });
  $(".popup-block__overlay").click(function() {
    closePopup();
  });

    // Поиск по нажатию на ссылку
    var searchForm = document.querySelector(".js-search-field");
    ...
    if (searchForm) {
        searchForm.addEventListener("click", function (evt) {
            ...
            if (target.classList.contains("search-block__mark")) {
                searchForm.querySelector("input").value = target.textContent;
                searchForm.submit();
            }
        });
    }
// 	$(".top-burger__checkbox").change(function() {
// 		if ($(".top-burger__checkbox").prop("checked")) {
// 			$("body").addClass("no-scroll");
// 		} else {
// 			$("body").removeClass("no-scroll");
// 		};
// 	});
	// закрытие выезжающего меню
// 	$(".close-top-menu").on('click', function(e) {
// 		$(".top-burger__checkbox").prop("checked", false);
// 		$("body").removeClass("no-scroll");
// 	});
// мобильный filter
var posY = 0;
$(".filter-burger__checkbox").change(function() {
	if ($(".filter-burger__checkbox").prop("checked")) {
		posY = $(window).scrollTop();
		$("body").addClass("no-scroll");
		$("body").scrollTop(posY);
		$(".personal__aside, .catalog-filter").css("right", "0px");
	} else {
		$("body").removeClass("no-scroll");
		$(window).scrollTop(posY);
		$(".personal__aside, .catalog-filter").css("right", "-270px");
	};
});
// закрытие выезжающего фильтра
$(function(){
	$(document).on('click', ".catalog-filter__close, .personal-nav__item", function(e) {
		$(".filter-burger__checkbox").prop("checked", false);
		$("body").removeClass("no-scroll");
		$(window).scrollTop(posY);
		$(".personal__aside, .catalog-filter").css("right", "-270px");
	});
...
$(function(){
  $(document).on('click', '[data-city-trigger]', function(){
    locationDND.isInformationStatus = false;
    locationDND.isPopupChangeCityVisible = true;
  });
});

// форматирует вид цены по 3 цифры

$(function () {
	$(".p-nav-bottom__price").each(function (i, price) {
...
$(function () {
	if ($(".catalog-filter__ul").children().length === 0) {
		$(".catalog-filter").addClass("visually-hidden");
		$(".catalog-block").css({'width' : '100%'});
  }
})
...
{
  $(document).on('click', '.js-related', function(e)
  {
    e.preventDefault();
    let url = $(this).data('url');

    if (url !== '' && url !== null && typeof url !== undefined && url !== window.location.pathname) {
...
$(document).ready(function() {
  $(document).on("click", ".catalog-filter__li button", function(evt){
		evt.preventDefault();
		$(this).parent(".catalog-filter__li").toggleClass("unfolded");
	});
});
$(function () {
	const inputs = document.querySelectorAll('.sci-top__count-change');
	for (let index = 0; index < inputs.length; index++) {
		const input = inputs[index];
		input.onkeydown = function (e) {
			return !(/^[-eА-Яа-яA-Za-z., ]$/.test(e.key));  // IE > 9
		}
	}
});

$(document).ready(function() {
  $(document).on("click", ".toggle-button-menu", function(evt){
		evt.preventDefault();
		$(".brands__list").toggleClass("unfolded");
	});
});
