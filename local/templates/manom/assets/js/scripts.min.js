...
$(".catalog-filter__close, .personal-nav__item").on('click', function(e) {
...
$(document).ready(function() {
  $(document).on("click", ".catalog-filter__li button", function(evt){
		...
		if ($(".catalog-filter__list-item input").prop('checked') == true) {
			alert(1)
			$(this).closest(".catalog-filter__list-item").css("max-height", "100px");
		}
	});
});
