...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MFLXNC9"
		...
		<div class="top-ad-line">
			<div class="container">
				<div class="top-ad-line__block">
					...
					<a href="" class="top-ad-line__close"><img src="<?=SITE_TEMPLATE_PATH?>/assets/img/top-close.svg" alt=""></a>
				</div>
			</div>
		</div>
		<!-- Верхняя навигация -->
		...
		<div class="top-nav2">
			<div class="container">
				<div class="top-nav2__block">
                    <?$APPLICATION->IncludeComponent("bitrix:catalog.section.list","main-menu",
                        Array(
                            "VIEW_MODE" => "TEXT",
                            "SHOW_PARENT_NAME" => "Y",
                            "IBLOCK_TYPE" => "catalog",
