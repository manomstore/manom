                            ...
                            <div class="sci-contact">
                                ...
                                <div class="sci-contact__tabs">
                                    ...
                                    <div class="sci-contact__top sci-contact__top--contacts">
                                        ...
                                        <label data-prop="PERSON_TYPE_1" class="sci-contact__tab-label rb_so" for="sci-contact-tab1">
                                            <span>Оформить как физ. лицо</span>
                                        </label>
                                        <label data-prop="PERSON_TYPE_2" class="sci-contact__tab-label rb_so" for="sci-contact-tab2">
                                            <span>Оформить как юр. лицо</span>
                                        </label>
                                    </div>
                                    <section class="sci-contact-content" id="sci-contact-content1">
                                        <? if (!$USER->IsAuthorized()): ?>
                                            <div class="js-email-block sci-contact__field">
                                                <label class="sci-contact__label" for="sci-contact__email">E-mail
                                                </label>
                                                <input type="email"
                                            ...
                                            <div class="js-password-block dsb-hidden sci-contact__field">
                                                <label class="sci-contact__label"
                                                       for="sci-contact__password">Пароль
                                                </label>
                                                <input type="password"
                                        ...
                                        <div class="sci-contact__field">
                                            <label class="sci-contact__label" for="sci-contact__fio">Фамилия и имя
                                            </label>
                                            <input type="text"
                                ...
                                <ul class="sci-delivery-tabs">
                                    <li class="sci-delivery-tab">
                                        ...
                                        <section class="sci-delivery-content current-content" id="sci-delivery-content1">
                                            ...
                                            <div class="sci-contact__field">
                                                <label for="sci-contact__label" class="sci-contact__label sci-contact__label--desc">
                                        ...
                                        <section class="sci-delivery-content" id="sci-delivery-content2">
                                            ...
                                            <div class="delivery-pickup-type" data-pickup-type="pvz">
                                                <div class="sci-contact__field">
                                                    <div class="pickup_address sci-contact__label">
                                                        Пункт самовывоза
                                                        <span class="sci-delivery__text" id="pvz_address">Не выбран
                                                        </span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="delivery-pickup-type" data-pickup-type="shop">
                                                <div class="sci-contact__label">
                                                    Адрес:
                                                    <span class="js-shop-address"></span>
                                                    <span class="sci-delivery__text">
                                                        Часы работы:
                                                        <span class="js-shop-schedule"></span>
                                                    </span>
                                                </div>
                                            </div>
                                        </section>
                            ...
                            */ ?>
                            ...
                            <div class="shopcart-sidebar__check">
                                ...
                                <div class="shopcart-sidebar__info shopcart-sidebar__info--delivery sc-hidden">
                                    ...
                                    <p class="shopcart-sidebar__text">
                                        <span class="shopcart-sidebar__delivery-date">
                                            <span></span>
                                        </span>
                                        <span class="shopcart-sidebar__delivery-time">,
                                            <span></span>
                                        </span>
                                    </p>

                                    <?php /*
                                    <p class="shopcart-sidebar__text shopcart-sidebar__delivery-time">
                                        Срок доставки: <span>2-3 дня</span>
                                    </p>
                                    */ ?>
                                </div>
                            ...
                            <div class="shopcart-sidebar__button-wrapper">
                                ...
                                */ ?>
                                ...
                                <?php /*
                                <div
                                    class="shopcart-sidebar__back-shopping BOC_btn"
                                    data-fancybox=""
                                    data-src="#popap-buy-one-click-cart"
                                    href="javascript:;"
                                >
                                    Купить в 1 клик
                                </div>
